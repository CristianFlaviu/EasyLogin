...
@Component({
  selector: 'app-tenant-role-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
...
export class TenantRoleDialogComponent {
  private readonly tenantAdmin = inject(TenantAdminService);
  private readonly snackBar = inject(MatSnackBar);
  readonly dialogRef = inject(MatDialogRef<TenantRoleDialogComponent>);
  ...
  submit(): void {
    ...
    this.loading = true;
    this.tenantAdmin.createRole({ name: name!, description: description || null }).subscribe({
